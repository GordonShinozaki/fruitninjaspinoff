...
WINDOW_NAME = "FruitNinja Spinoff"
...
ORANGE_SIZES = (50, 38)
ORANGE_SIZE_RANDOMIZE = (1,2) # for each new fruit, it will multiply the size with an random value beteewn X and Y
BEE_SIZES = (50, 50)
